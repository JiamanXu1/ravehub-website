...
export const Footer = () => {
  ...
  return (
    <>
      <footer id="contact" className="relative flex h-screen items-center overflow-hidden border-t border-white/5 bg-neutral-950 px-6 py-12">
        <div className="container mx-auto">
          <div className="mb-14 grid gap-12 md:grid-cols-[1.5fr_1fr]">
            ...
            <div>
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="mb-12 text-6xl font-medium leading-[0.9] tracking-tighter md:text-8xl"
              >
                Let's <br />
              ...
              <div className="flex flex-col gap-8">
                 ...
                 >
                   ...
                   <div>
                     <span className="block text-4xl font-light tracking-tighter text-white group-hover:translate-x-2 transition-transform duration-300">加入我们</span>
        ...
        <>
          ...
          >
            ...
            {formState === 'success' ? (
              ...
              <div className="mt-12">
                <span className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-6 block">05 / Contact</span>
